  ...
  render() {
    ...
    return (
      <Dialog open={this.props.open} onClose={this.handleClose} aria-labelledby="form-dialog-title">
        <DialogTitle id="form-dialog-title">Create new build for {repository.owner}/{repository.name}</DialogTitle>
        <DialogContent>
          <DialogContentText>
            Please customize parameters for a build.
          </DialogContentText>
          <TextField
            margin="dense"
            id="branch"
          ...
          />
          <DialogContentText>
            Optionally you can override build configuration:
          </DialogContentText>
          <AceEditor
            mode="yaml"
            theme="github"
