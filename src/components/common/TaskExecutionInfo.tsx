...
const CPUChart = (props: { props: Props }) => {
...
const MemoryChart = (props: { props: Props }) => {
  let { task } = props.props;
  let info = task.executionInfo;
...
const TaskExecutionInfo = (props: Props) => {
  let { task, classes, isOpen } = props;
  ...
  return (
    <div>
      ...
      <div className="row">
        {isOpen ? <CPUChart props={props} /> : null}
        {isOpen ? <MemoryChart props={props} /> : null}
      </div>
    </div>
  );
};
